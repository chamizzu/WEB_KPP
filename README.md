...
<body class="bg-gray-800 text-white">
    ...
    <main>
        <!-- Home Section -->
        <section id="home" class="h-screen flex items-center justify-center bg-gray-700">
            <div class="text-center">
                ...
                <p class="text-xl max-w-3xl mx-auto">
                    ...
                    Dimana disini kita akan diajarkan mengenai dasar-dasar dari Design, Copywrite,
        ...
        <section id="about" class="py-16">
            <div class="container mx-auto">
                <h2 class="text-4xl font-bold mb-8 -rotate-90 absolute left-0">KELOMPOK 8</h2>
                <div class="grid grid-cols-4 gap-8 ml-20">
                    <div class="text-center">
                        ...
                        <p>Lombok</p>
                        <p class="text-sm">Membaca apa sja dibaca</p>
                    </div>
                    <div class="text-center">
        ...
        <section id="works" class="py-16 bg-gray-700">
            <div class="container mx-auto">
                <h2 class="text-4xl font-bold mb-8 -rotate-90 absolute left-0">OUR WORKS</h2>
        ...
        <section id="photos" class="py-16">
            <div class="container mx-auto">
                <h2 class="text-4xl font-bold mb-8 -rotate-90 absolute left-0">PHOTOS</h2>
                <div class="grid grid-cols-4 gap-4 ml-20">
                    <div class="bg-gray-600 h-48"></div>
                    <div class="bg-gray-600 h-48"></div>
                    <div class="bg-gray-600 h-48"></div>
                    <div class="bg-gray-600 h-48"></div>
                    <div class="bg-gray-600 h-48"></div>
